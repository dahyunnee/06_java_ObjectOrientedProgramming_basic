...
class ReturnEx {
	...
	int testReturn () {
		...
		//return을 만나는 순간 함수가 종료되므로 아래의 명령어는 
		//error을 일으킨다.
...
public class MethodEx03 {
	...
	public static void main(String[] args) {
		...
		System.out.println("메소드 호출 전의 성적 = " + score1);
		
		obj.setScore1(score1);
		System.out.println("메소드 호출 후의 성적 = " + score1);
		
		System.out.println("=================================");
		
		int score2 = 87;
		
		System.out.println("메소드 호출 전의 성적 = " + score2);
		
		obj.setScore2(score2);
		System.out.println("메소드 호출 후의 성적 = " + score2);
